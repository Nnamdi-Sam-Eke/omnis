...
const ActionButtons = () => {
  ...
  return (
    <div className="grid grid-cols-1 lg:grid-cols-2 mt-8 min-w-[250px]  hover:shadow-blue-500/50 transition px-6 py-6 border bg-white dark:bg-gray-800 p-6 rounded-2xl shadow-md">
