    ...
    <div className="min-h-screen flex flex-col items-center justify-center bg-gray-100">
      {!showForm ? (
        <div className="flex items-center space-x-4">
          <p className="text-5xl text-gray-800 italic font-light shadow font-cursive shadow-lg">New to Omnis?</p>
          <button
        ...
        <div className="flex flex-col items-center justify-center h-screen bg-gray-100 text-gray-900">
          ...
          <form onSubmit={handleResetPassword} className="bg-white p-8 rounded-lg shadow-xl w-96">
            <input
              type="email"
        ...
        <div className="flex flex-col items-center justify-center h-screen bg-gray-100 text-gray-900">
          <h2 className="text-3xl font-extrabold mb-6 font-serif">
