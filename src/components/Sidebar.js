  ...
  return (
    <>
      ...
      <aside
        ref={sidebarRef}
        id="sidebar"
        className={`fixed inset-y-0 left-0 w-64 transition-transform duration-300 z-30
          bg-gradient-to-r from-blue-600 to-green-500 text-white dark:bg-gray-800
        ...
        <div className="h-full overflow-y-auto p-4 flex flex-col justify-between">
          ...
          <div className="sm:hidden mt-4 flex bg-gray-300 rounded-xl p-2 justify-around text-sm">
            ...
            <Tooltip text="Notifications" position="top">
              <Link
                to="/notifications"
                className="cursor-pointer hover:text-blue-200 relative"
                onClick={() => setIsSidebarOpen(false)}
              >
                🔔
                {unreadCount > 0 && (
